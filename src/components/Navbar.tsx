...
const Navbar = () => {
  return (
    <div className="flex flex-col md:flex-row bg-white md:items-center md:border-b md:border-[#C3D4E966] px-6 py-4">
      <div className="flex items-center justify-between mb-8 md:mb-0">
        ...
        <div className="border border-[#C3D4E966] rounded-full p-2 md:hidden">
          <svg
...
function Profile() {
  return (
    <div className="hidden md:flex items-center gap-4 flex-row-reverse">
      <div className="hover:shadow-md duration-200 border border-[#C3D4E966] rounded-full p-2">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="w-6 h-6"
          viewBox="0 0 24 24"
